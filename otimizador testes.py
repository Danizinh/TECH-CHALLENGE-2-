...
import itertools
import numpy as np
from genetic_algorithm import mutate as mutacao, order_crossover as cruzamento, order_crossover_2childs as cruzamento_2, generate_random_population as gerar_populacao, calculate_fitness as calcular_aptidao, sort_population as ordenar_populacao
import folium
...
while n_test < N_TESTES:
    ...
    while melhor_aptidao > MENOR_DIST or geracao > N_GERACOES:
        ...
        #print(f"Geração {geracao}: Melhor distância = {round(melhor_aptidao, 2)} km - {melhor_solucao}")
